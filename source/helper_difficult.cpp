...
void init_monster(Monster_Map* const monster_map){
    monster_map->set_monster(2, 2, new Monster("Slime", 100, 6, 4, 4, 2, 2, 5, ICE));
    monster_map->set_monster(2, 4, new Monster("Centipedes", 20, 30, 6, 4, 4, 2, 5, FIRE));
    monster_map->set_monster(3, 3, new Monster("Zombie", 100, 6, 10, 4, 3, 3, 5, WIND));
    monster_map->set_monster(5, 5, new Monster("Giant Squid", 1000, 6, 12, 4, 5, 5, 5, THUNDER));
    monster_map->set_monster(4, 2, new Monster("Dragon", 1000, 60, 15, 50, 2, 4, 50, ICE));
}
